...
function menu_init(url) {
	var linkstr = ['index;TOP', 'story/index;ストーリー攻略', 'story/map;マップ一覧', 'hhyoma;変異憑魔一覧', 'sp_chat;サポートタレント関連のチャット', 'prest;状態異常防止', 'skill;スキル一覧', 'attack;術技', 'degree;称号', 'bttact;バトルアクト', 'weapon;武器', 'chat/index;チャットデータ', 'enemy/index;敵データ'];
